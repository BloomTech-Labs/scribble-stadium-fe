...
function RenderWordCloud() {
    ...
    useEffect(() => {
        axios.get("http://labspt21benv5.eba-nmemcxkm.us-east-1.elasticbeanstalk.com/storytext")
        ...
        <div classNameName="wordCloudContainer">
            <div className="centerer">
                <div className="switcher">
                    ...
                    checked={cloud === "cropcloud"} defaultChecked/>
                    <label for="cropcloud" className="switcher__label">Crop Cloud</label>
                    ...
                    <label for="wordcloud" className="switcher__label">Word Cloud</label>
